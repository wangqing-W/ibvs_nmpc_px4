...
int main( ){
  ...
  */
  ...
  {
    // Set initial state
    ocp.subjectTo( AT_START, p_x ==  -2.982 );
    ocp.subjectTo( AT_START, p_y ==  -0.495452 );
    ocp.subjectTo( AT_START, p_z ==  0.869268 );
    ocp.subjectTo( AT_START, q_w ==  0.999502 );
    ocp.subjectTo( AT_START, q_x ==  -0.00768312 );
    ocp.subjectTo( AT_START, q_y ==  0.0306208 );
    ocp.subjectTo( AT_START, q_z ==  0.0 );
    ocp.subjectTo( AT_START, v_x ==  0.11562 );
    ocp.subjectTo( AT_START, v_y ==  0.0291604 );
    ocp.subjectTo( AT_START, v_z ==  0.0162533 );
    ...
    ocp.subjectTo( AT_START, p_F_x ==  0 );
    ...
    // window3.addSubplot( intSx,"intSx" );

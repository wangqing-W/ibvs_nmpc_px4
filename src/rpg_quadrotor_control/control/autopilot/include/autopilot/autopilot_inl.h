...

{
  ...
  enable_command_feedthrough_sub_ = nh_.subscribe(
      "autopilot/command_feedthrough", 1,
      &AutoPilot<Tcontroller, Tparams>::feedCommandInputCallback, this);
...
template <typename Tcontroller, typename Tparams>
void AutoPilot<Tcontroller, Tparams>::feedCommandInputCallback(const std_msgs::Bool::ConstPtr& msg){
  if(msg->data == true) {
    std::cout << "[INFO] Switch to COMMAND_FEEDTHROUGH State!!!!!!!" << std::endl;

...
if(NOT "/home/zyh/ibvs_nmpc_ws/src/circle-detection/include " STREQUAL " ")
  set(circle_detection_INCLUDE_DIRS "")
  set(_include_dirs "/home/zyh/ibvs_nmpc_ws/src/circle-detection/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'circle_detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zyh/ibvs_nmpc_ws/src/circle-detection/${idir}'.  ${_report}")
    endif()
